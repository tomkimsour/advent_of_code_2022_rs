...
pub fn part_two(input: &str) -> Option<u32> {
    ...
    for i in 1..row_len {
        for j in 1..col_len {
            ...
            let res: u32 = forest_matrix.trees[i][j].visibility_bottom
                * forest_matrix.trees[i][j].visibility_right
                * forest_matrix.trees[i][j].visibility_left
                * forest_matrix.trees[i][j].visibility_top;
